...
export interface ApiAttributeValueAttributeValue
  ...
  info: {
    description: 'A specific value for a product attribute (e.g. Lavanda, 1 Litro, Industrial)';
...
export interface ApiAttributeAttribute extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Filterable product attribute (e.g. Fragancia, Presentaci\u00F3n, Uso recomendado)';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    filterable: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::attribute.attribute'
...
export interface ApiBrandBrand extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product brand or supplier line (e.g. Diversey, Fiorentina, Aliadas)';
    displayName: 'Brand';
    pluralName: 'brands';
    singularName: 'brand';
  };
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product category \u2014 supports two-level hierarchy (parent + subcategories)';
...
export interface ApiHomeSectionHomeSection extends Struct.SingleTypeSchema {
  collectionName: 'home_sections';
  info: {
    description: 'Configurable homepage content blocks';
  ...
  attributes: {
    categoryHighlights: Schema.Attribute.Relation<
      'manyToMany',
      'api::category.category'
    >;
    categoryHighlightsTitle: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }> &
    ...
    featuredProductsTitle: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Productos Destacados'>;
    ...
    offersTitle: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Ofertas del Mes'>;
    promotionalBanners: Schema.Attribute.Component<'shared.banner', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global homepage content \u2014 hero, featured sections, etc.';
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Cleaning product with pricing, images, attributes and SEO';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    ...
    unit: Schema.Attribute.Enumeration<
      ['unidad', 'litro', 'kilo', 'metro', 'par', 'pack', 'caja', 'rollo']
    > &
...
export interface ApiPromotionPromotion extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Time-limited promotional banner with optional product linking';
